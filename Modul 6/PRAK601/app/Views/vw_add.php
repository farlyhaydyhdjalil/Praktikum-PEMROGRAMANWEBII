            ...
            <div class="card-header text-white" style="background-color: #f0768b;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group text-right">
                        <button class="btn btn-success" style="background-color: #dc3545">Simpan</button>
                        <a href="<?= base_url('home') ?>" class="btn btn-secondary" style="background-color: #000000">Kembali</a>
                    </div>
                    <?= form_close(); ?>
                </div>
            </div>
